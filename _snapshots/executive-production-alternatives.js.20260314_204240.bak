    ...
    return `
      <div class="zp-switch-shell">
        <div class="zp-switch-head">
          <div>
            <div class="zp-switch-title">Simulate Machine Switch</div>
            <div class="zp-switch-subtitle">
              Compare <strong>${escapeHtml(text(recommended.machine))}</strong> vs
              <strong>${escapeHtml(text(alternative.machine))}</strong>
            </div>
          </div>
        ...
        <div class="zp-load-simulator">
          <div class="zp-load-title">Production What-If</div>
...
<div class="zp-switch-grid">
          ${renderCompareMetricPct("Load %", cmp.loadPct, 1)}
          ${renderCompareMetric("Energy", cmp.energy, "kWh", 2)}
          ${renderCompareMetric("Water", cmp.water, "L", 0)}
          ${renderCompareMetric("CO₂", cmp.co2, "kg", 2)}
        </div>
